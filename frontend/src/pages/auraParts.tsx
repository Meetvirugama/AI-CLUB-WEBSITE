...
export const facultyMembers: FacultyMember[] = [
  {
    ...
    roleInAura: 'Vision',
    specialization: 'Microelectronics, Telecommunications, Technology-led Innovation',
    researchAreas: ['Microelectronics', 'Telecommunications', 'Technology-led Innovation'],
    experience: 'Eminent Academician & Industry Leader',
    education: 'Ph.D. in Computer Science (TIFR, Mumbai)',
    email: '',
    ...
    skills: ['Microelectronics', 'Telecommunications', 'Technology Innovation'],
  },
  {
    id: 'f2',
    name: 'Dr. Arpit Rana',
